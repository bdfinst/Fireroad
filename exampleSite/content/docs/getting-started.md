...
description: This article helps you get started with the Fireroad theme, including installation and minimal
  configuration.
lead: This article helps you get started with the Fireroad theme, including installation and minimal configuration.
...
Welcome to the Fireroad theme documentation. This quick start guide covers Fireroad theme installation and minimal
...
Before installing the **Fireroad** theme, make sure that you've
...
**[download ZIP](https://github.com/bdfinst/Fireroad/archive/master.zip)** and extract it into the `themes/Fireroad`
...
**Do not copy the [example config](https://github.com/bdfinst/Fireroad#configtoml-example) as-is.**
Use only the parameters that you need. The Fireroad theme contains required defaults, so you don't need to add all of
...
For information about common customization settings, see [Customization page]({{< relref "/docs/customization.md" >}} "Fireroad theme customization").
To view our example configuration, visit [demo config](https://github.com/bdfinst/Fireroad/blob/master/exampleSite/config.toml).

[Edit this page on GitHub](https://github.com/bdfinst/Fireroad/blob/master/exampleSite/content/docs/getting-started.md)
